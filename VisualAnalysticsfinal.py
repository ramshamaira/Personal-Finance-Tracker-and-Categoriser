...
import Transactionscreen as tras
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg
import json
import budgetscreen as bas
...
class VisualAnalyticsApp:
    def __init__(self, root):
        ...
        self.root = root
        self.window.title("Visual Analytics")
        ...
        nav_items = ["Dashboard", "Transactions", "Visual Analystics", "Budget", "Help"]
    ...
    def show_notifications(self, transactions):
        ...
        self.notification_frame = Frame(self.window, bg="white")
    ...
    def top_navgiation_button_click(self, name):
        if name == "Budget":
            bas.BudgetScreenApp(self.root)
            print("has been clicked")

        elif name == "Dashboard":
            messagebox.showinfo("Dashboard", "You are already on the Dashboard screen.")
